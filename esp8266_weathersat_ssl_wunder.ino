...
const char* host = "splunkhost.dom";
...
void loop(void) 
{
 ...
 if (client.verify(fingerprint, host)) {
  ...
  client.println("Authorization: Splunk TOKEN################");
  ...
  float hg_in= (.02952998751 * pressure); 
  String url2 = String("/weatherstation/updateweatherstation.php?ID=STATIONID&PASSWORD=PASS&dateutc=now&tempf=") + f + String("&baromin=") + hg_in + String("&dewptf=") + dewpt + String("&humidity=") + h + String("&softwaretype=esp8266%20version1.0&action=updateraw&realtime=1&rtfreq=2.");
  Serial.print("Posting to URL: ");
